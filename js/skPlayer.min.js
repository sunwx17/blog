                ...
                l = function () {
                    ...
                    return r(t, [{
                        ...
                        value: function () {
                            ...
                            }, this.audio = this.root.querySelector(".skPlayer-source"), this.option.listshow && (this.root.className = "skPlayer-list-on"), "singleloop" === this.option.mode && (this.audio.loop = !0), this.dom.musicitem[0].className = "skPlayer-curMusic", "cloud" === this.type &&( 
							/*s.ajax({
							...
							t.audio.src = a + 'song/media/outer/url?id=' + this.music.result.tracks[0] + '.mp4'
                        )}
                    }, {
                        key: "bind",
                        value: function () {
...
//# sourceMappingURL=js/skPlayer.min.js.map